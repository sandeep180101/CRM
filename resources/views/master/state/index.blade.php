...
<section class="section">
            ...
            <table class="table table-bordered">
              ...
              <tbody>   
                <tr>
                  ...
                  <td>{{ $states->status}}</td>
                  <td> <a href="{{url('states/'. Crypt::encrypt($states->id))}}"><i class="bi bi-pencil-square mx-1"></i></a><a href="#"><i class="bi bi-trash mx-2"></i></a></td>
                </tr>
                @endforeach
  ...
  <script type="text/javascript" src="{{url('public/validations/states.js')}}"></script>
@endsection