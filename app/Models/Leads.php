...
class Leads extends Model
{
    ...
    public static function getAllLeads($params = [])
    {
        ...
        $query->select(
            ...
            'l.lead_for_id',
            'lfor.lead_for_name',
            DB::raw('date_format(l.created_at,"%d-%m-%Y %H:%i:%s") as lead_timestamp_created'),
            DB::raw('date_format(l.updated_at,"%d-%m-%Y %H:%i:%s") as lead_timestamp_updated'),
            DB::raw('date_format(l.date,"%d-%m-%Y %H:%i:%s") as lead_created'),
            'co.country_name',
            's.state_name',
            'c.city_name',
